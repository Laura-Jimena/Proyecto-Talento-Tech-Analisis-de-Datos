...
with st.sidebar:
    selected = option_menu(
        ...
        options=["EDITS 2016-2017/2018-2019/2020-2021","1. Empresas que introdujeron bienes o servicios nuevos.", "2. N° promedio de bienes/servicios nuevos por periodo.", "3.Número total de innovaciones por periodo.", 
                 "4.Innovación por actividad económica.", "5.Empresas por tipología y periodo.","6.Empresas con bienes mejorados.","7.Impacto en la innvación.","8.Introdujeron un bien o servicio unicamente en el mercado internacional.","9.Impacto en la innovación de las empresas de servicios."],
        icons=["bi-calendar","bi-lightbulb", "bi-award", "bi-calendar-range", "bi-file-earmark-bar-graph", "bi-briefcase","bi-journal-check","bi-graph-up","bi-globe","bi-briefcase"],  # Iconos de Bootstrap
...
df=pd.merge(df,emp, left_on='CIIU4', right_on='Indice',how="inner")
...
if selected =="EDITS 2016-2017/2018-2019/2020-2021":
    ...
    fig.add_trace(go.Bar(
        ...
        textposition='inside',
        textfont=dict(size=22)  # Las etiquetas estarán dentro de las barras
    ))
    ...
    st.title("I1R1C2N:Número total de innovaciones en servicios o bienes nuevos únicamente para su empresa por periodo.")
    ...
    fig.add_trace(go.Bar(
        ...
        textfont=dict(size=22)  # Las etiquetas estarán fuera de las barras
    ))
    ...
    count_data = df.groupby(['Actividad económica', 'Periodo']).size().reset_index(name='Número de empresas')
    ...
    fig = px.bar(count_data,
                ...
                category_orders={'Actividad económica': df['Actividad económica'].value_counts().index},
                title='Distribución de empresas que innovan por actividad económica y año',
    ...
    fig.update_traces(texttemplate='%{y}', textposition='outside', insidetextanchor='start')
    ...
    fig = px.bar(count_data,
                ...
                title='Distribución de empresas por tipología y año',
    ...
    fig = px.bar(bienes_mejorados, x='Periodo', y=['Sí', 'No'], 
                title='Porcentaje de empresas con bienes/servicios mejorados por año',
    ...
    fig.update_layout(
        barmode='stack',
        title=title_text,
        xaxis=dict(title="Ítems de impacto", tickangle=-45),
        yaxis=dict(title="Proporción de respuestas", tickformat=".0%"),
    ...
    st.plotly_chart(fig)
if selected=="8.Introdujeron un bien o servicio unicamente en el mercado internacional.":
    st.write("1")
if selected=="9.Impacto en la innovación de las empresas de servicios.":
    ...
    I2R17C1: Ha mantenido su Participación en el mercado geografico de su empresa.""")
